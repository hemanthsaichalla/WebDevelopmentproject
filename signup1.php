  ...
  <hr/>
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
	  ...
	  if ($_POST['eventname'] == "unknown") {
		...
		//validation for number of attendees between 5 and 12 years
		...
		//validation for number of attendees over 18 years
		...
		<article class="main">
          ...
          <div class="signupform">
						<div class="gridview">
								...
								<div>
								  <input type="text" name="firstname" id="firstname" onchange="titleCasefirstname()" size="40"  maxlength="60" value="<?php echo $firstname; ?>" /><br/><span class = "error"><?php echo " " . $firstnameErr;?></span>
							  </div>
						</div>
						...
						<div class="gridview">
								...
								<div>
								  <input type="text" name="lastname" id="lastname" onchange="titleCaselastname()" size="40"  maxlength="60" value="<?php echo $lastname; ?>"/><br/><span class = "error"><?php echo " " . $lastnameErr;?></span>
								</div>
						</div>
						...
						<div class="gridview">
								...
								<div>
								  <input type="text" name="attendeesone" onchange = "onAttendeCountChange()" id="attendeesone" size="40"  maxlength="60" value="<?php echo $attendeesone; ?>"/><br/><span class = "error"><?php echo " " . $attendeesoneErr;?></span>
								</div>
						</div>
						<div class="gridview">
								<label for="attendeestwo">Number of attendees between 5 and 12 years old<span class="required">*</span>:</label>
                        <div>
								  <input type="text" name="attendeestwo" onchange = "onAttendeCountChange()" id="attendeestwo" size="40"  maxlength="60" value="<?php echo $attendeestwo; ?>"/><br/><span class = "error"><?php echo " " . $attendeestwoErr;?></span>
								</div>
						</div>
						<div class="gridview">
								<label for="attendeesthree">Number of attendees 13 to 17 years old<span class="required">*</span>:</label>
								<div>
								  <input type="text" name="attendeesthree" onchange = "onAttendeCountChange()" id="attendeesthree" size="40"  maxlength="60" value="<?php echo $attendeesthree; ?>"/><br/><span class = "error"><?php echo " " . $attendeesthreeErr;?></span>
								</div>
						</div>
						<div class="gridview">
							<label for="attendeesfour">Number of attendees 18+ years old<span class="required">*</span>:</label>
							<div>
							  <input type="text" name="attendeesfour" onchange = "onAttendeCountChange()" id="attendeesfour" size="40"  maxlength="60" value="<?php echo $attendeesfour; ?>"/><br/><span class = "error"><?php echo " " . $attendeesfourErr;?></span>
							</div>
						</div>
						<div class="gridview">
									<label for="attendees">Total number of attendees:</label>
									<div>
									  <input type="text" name="attendees" id="attendees" size="40"  maxlength="60" value="<?php echo $totalattendees; ?>"/>
									</div>
						</div>
					</div>
						<div class="gridview">
